...
public class cards_test
{
    ...
    public void cards_testAddCard()
    {
        ...
        Card.AddCard(pool.cards[0]);        //attempting to add a card 
    ...
    public void cards_testFindCombo()
    {
        ...
        Card firstCard = pool.cards[2];     //a card that combines with second
        Card secondCard = pool.cards[3];    //a card that combines with first                        
    ...
    public void cards_testCraftZone()
    {
        ...
        secondCard.AddCard(pool.cards[3]);
    ...
    {
        ZoneCards MainScreen = new ZoneCards();
    ...
    public void cards_testMapZone()
    {
        ...
        CardDrag Card = new CardDrag();
        Card.AddCard(pool.cards[8]);                //create a building card
